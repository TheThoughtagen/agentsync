...
- [x] **CLI-05**: User can run `aisync watch` to start a daemon that auto-syncs on file changes
...
- [x] **INST-08**: Bidirectional sync detects external edits to tool-native files and reverse-syncs to `.ai/`
